...
@Schema(description = "管理后台 - 批量交易买单分页 Request VO")
@Data
public class BuyOrderPageReqVO extends PageParam {

    @Schema(description = "用户id", example = "21315")
    private Long userId;
    ...
    @Schema(description = "价格，单位：分", example = "20287")
