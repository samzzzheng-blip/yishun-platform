package com.techtron.onebook.module.app.dal.mysql.collectiontransfer;
 ...
 */
@Mapper
public interface CollectionTransferItemMapper extends BaseMapperX<CollectionTransferItemDO> {
