...
public class NotifyProducer {
    ...
    public void sendNotifySendMessage(String templateCode, Long userId, Integer dealAmount, Integer price, Integer totalPrice) {
        // 1、构造消息
        Map<String, Object> msgMap = new HashMap<>(2);
        msgMap.put("dealAmount", dealAmount);
        msgMap.put("price", MoneyUtils.fenToYuanStr(price));
        if(totalPrice !=null) {
            msgMap.put("totalPrice", MoneyUtils.fenToYuanStr(totalPrice));
        }
        // 2、发送站内信
