package com.techtron.onebook.module.app.controller.admin.brokerage.vo.withdraw;
...
public class BrokerageWithdrawRespVO {
    ...
    private Integer sourceGrossAmount;
    private Integer sourceFeeRate;
    private Integer sourceFeeAmount;
    ...
    @Schema(description = "当前总余额", requiredMode = Schema.RequiredMode.REQUIRED, example = "18576")
