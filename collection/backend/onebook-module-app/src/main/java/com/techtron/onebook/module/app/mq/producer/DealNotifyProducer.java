...
@Slf4j
@Component
public class DealNotifyProducer {

    @Resource
    private ApplicationContext applicationContext;


    public void sendNotifySendMessage(String templateCode, Long userId, String name, Integer price) {
        // 1、构造消息
        Map<String, Object> msgMap = new HashMap<>(2);
        msgMap.put("collectionName", name);
        msgMap.put("dealPrice", MoneyUtils.fenToYuanStr(price));
        // 2、发送站内信
