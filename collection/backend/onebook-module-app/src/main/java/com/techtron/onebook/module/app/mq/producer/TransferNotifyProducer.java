...
@Slf4j
@Component
public class TransferNotifyProducer {

    @Resource
    private ApplicationContext applicationContext;


    public void sendNotifySendMessage(String templateCode, Long userId, String userName, String collectionName) {
        // 1、构造消息
        Map<String, Object> msgMap = new HashMap<>(3);
        msgMap.put("userName", userName);
        msgMap.put("collectionName", collectionName);
        // 2、发送站内信
