package com.techtron.onebook.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.techtron.onebook.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.techtron.onebook.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
