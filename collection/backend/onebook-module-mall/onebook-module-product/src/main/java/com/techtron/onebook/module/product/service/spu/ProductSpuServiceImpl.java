package com.techtron.onebook.module.product.service.spu;
...
import com.techtron.onebook.module.product.controller.admin.category.vo.ProductCategoryListReqVO;
import com.techtron.onebook.module.product.controller.admin.spu.vo.ProductSkuSaveReqVO;
import com.techtron.onebook.module.product.controller.admin.spu.vo.ProductSpuPageReqVO;
import com.techtron.onebook.module.product.controller.admin.spu.vo.ProductSpuSaveReqVO;
import com.techtron.onebook.module.product.controller.admin.spu.vo.ProductSpuUpdateStatusReqVO;
import com.techtron.onebook.module.product.controller.app.spu.vo.AppProductSpuPageReqVO;
import com.techtron.onebook.module.product.controller.app.spu.vo.AppProductSpuRespVO;
import com.techtron.onebook.module.product.dal.dataobject.category.ProductCategoryDO;
import com.techtron.onebook.module.product.dal.dataobject.sku.ProductSkuDO;
import com.techtron.onebook.module.product.dal.dataobject.spu.ProductSpuDO;
import com.techtron.onebook.module.product.dal.mysql.spu.ProductSpuMapper;
import com.techtron.onebook.module.product.enums.spu.ProductSpuStatusEnum;
import com.techtron.onebook.module.product.service.category.ProductCategoryService;
import com.techtron.onebook.module.product.service.sku.ProductSkuService;
...
import static com.techtron.onebook.module.product.enums.ErrorCodeConstants.*;
...
public class ProductSpuServiceImpl implements ProductSpuService {
    ...
    public PageResult<AppProductSpuRespVO> getSpuPage(AppProductSpuPageReqVO pageReqVO) {
        ...
        List<AppProductSpuRespVO> spuList = voPageResult.getList();
        List<Long> spuIds = spuList.stream().map(AppProductSpuRespVO::getId).toList();

        Map<Long, List<ProductSkuDO>> skuMap = productSkuService.getSkuListBySpuId(spuIds)
                .stream()
                .collect(Collectors.groupingBy(ProductSkuDO::getSpuId));

        spuList.forEach(spu -> {
            List<ProductSkuDO> skus = skuMap.getOrDefault(spu.getId(), Collections.emptyList());
            List<ProductSkuRespDTO> skuDTOs = BeanUtils.toBean(skus, ProductSkuRespDTO.class);
            spu.setSkuList(skuDTOs);
        });
        return voPageResult;
