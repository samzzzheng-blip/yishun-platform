...
import com.techtron.onebook.module.promotion.controller.admin.bargain.vo.help.BargainHelpPageReqVO;
import com.techtron.onebook.module.promotion.controller.app.bargain.vo.help.AppBargainHelpCreateReqVO;
import com.techtron.onebook.module.promotion.dal.dataobject.bargain.BargainActivityDO;
import com.techtron.onebook.module.promotion.dal.dataobject.bargain.BargainHelpDO;
import com.techtron.onebook.module.promotion.dal.dataobject.bargain.BargainRecordDO;
import com.techtron.onebook.module.promotion.dal.mysql.bargain.BargainHelpMapper;
...
public class BargainHelpServiceImpl implements BargainHelpService {
    ...
    // TODO 天呈：优化点：实现一个更随机的逻辑，可以按照你自己的业务；
