...
import com.techtron.onebook.module.trade.controller.admin.brokerage.vo.user.BrokerageUserCreateReqVO;
import com.techtron.onebook.module.trade.controller.admin.brokerage.vo.user.BrokerageUserPageReqVO;
import com.techtron.onebook.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserChildSummaryPageReqVO;
import com.techtron.onebook.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserChildSummaryRespVO;
import com.techtron.onebook.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByUserCountRespVO;
import com.techtron.onebook.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import com.techtron.onebook.module.trade.convert.brokerage.BrokerageUserConvert;
...
import com.techtron.onebook.module.trade.dal.mysql.brokerage.BrokerageUserMapper;
import com.techtron.onebook.module.trade.enums.brokerage.BrokerageBindModeEnum;
import com.techtron.onebook.module.trade.enums.brokerage.BrokerageEnabledConditionEnum;
...
import static com.techtron.onebook.framework.common.util.collection.CollectionUtils.convertMapByFilter;
...
public class BrokerageUserServiceImpl implements BrokerageUserService {
    ...
    public Long createBrokerageUser(BrokerageUserCreateReqVO createReqVO) {
        ...
        if (createReqVO.getBindUserId() != null) {
