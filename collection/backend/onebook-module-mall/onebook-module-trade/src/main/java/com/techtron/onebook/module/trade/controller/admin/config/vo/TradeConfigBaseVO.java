package com.techtron.onebook.module.trade.controller.admin.config.vo;

import com.techtron.onebook.framework.common.validation.InEnum;
...
public class TradeConfigBaseVO {
    ...
    @Schema(description = "分销海报图地址数组", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.iocoder.cn/onebook.jpg]")
