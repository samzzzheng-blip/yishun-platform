package com.techtron.onebook.module.trade.service.brokerage;
...
import com.techtron.onebook.framework.mybatis.core.util.MyBatisUtils;
...
import com.techtron.onebook.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import com.techtron.onebook.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import com.techtron.onebook.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import com.techtron.onebook.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import com.techtron.onebook.module.trade.convert.brokerage.BrokerageRecordConvert;
import com.techtron.onebook.module.trade.dal.dataobject.brokerage.BrokerageRecordDO;
import com.techtron.onebook.module.trade.dal.dataobject.brokerage.BrokerageUserDO;
import com.techtron.onebook.module.trade.dal.dataobject.config.TradeConfigDO;
import com.techtron.onebook.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
import com.techtron.onebook.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import com.techtron.onebook.module.trade.enums.brokerage.BrokerageRecordStatusEnum;
import com.techtron.onebook.module.trade.service.brokerage.bo.BrokerageAddReqBO;
import com.techtron.onebook.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
import com.techtron.onebook.module.trade.service.config.TradeConfigService;
...
import static com.techtron.onebook.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.techtron.onebook.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.techtron.onebook.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.techtron.onebook.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
