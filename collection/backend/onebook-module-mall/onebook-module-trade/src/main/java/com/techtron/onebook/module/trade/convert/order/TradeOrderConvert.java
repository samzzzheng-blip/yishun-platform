...
import com.techtron.onebook.framework.common.util.string.StrUtils;
import com.techtron.onebook.framework.dict.core.DictFrameworkUtils;
import com.techtron.onebook.framework.ip.core.utils.AreaUtils;
...
import com.techtron.onebook.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.techtron.onebook.module.product.api.sku.dto.ProductSkuRespDTO;
import com.techtron.onebook.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.techtron.onebook.module.product.api.spu.dto.ProductSpuRespDTO;
import com.techtron.onebook.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.techtron.onebook.module.trade.api.order.dto.TradeOrderRespDTO;
import com.techtron.onebook.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.techtron.onebook.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.techtron.onebook.module.trade.controller.admin.order.vo.*;
import com.techtron.onebook.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.techtron.onebook.module.trade.controller.app.order.vo.*;
import com.techtron.onebook.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.techtron.onebook.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.techtron.onebook.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.techtron.onebook.module.trade.framework.order.config.TradeOrderProperties;
import com.techtron.onebook.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.techtron.onebook.framework.common.util.collection.CollectionUtils.convertMap;
import static com.techtron.onebook.framework.common.util.collection.CollectionUtils.convertMultiMap;
...
public interface TradeOrderConvert {
    ...
    default PayOrderCreateReqDTO convert(TradeOrderDO order, List<TradeOrderItemDO> orderItems,
        ...
        createReqDTO.setBody(subject); // TODO 天呈：临时写死
        // 订单相关字段
