package com.techtron.onebook.framework.ratelimiter.config;

import com.techtron.onebook.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.techtron.onebook.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.techtron.onebook.framework.ratelimiter.core.keyresolver.impl.*;
import com.techtron.onebook.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class OnebookRateLimiterConfiguration {
