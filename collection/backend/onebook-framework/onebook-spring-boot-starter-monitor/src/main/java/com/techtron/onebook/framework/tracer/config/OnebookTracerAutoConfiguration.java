...
import com.techtron.onebook.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "onebook.tracer", value = "enable", matchIfMissing = true)
public class OnebookTracerAutoConfiguration {

    // TODO @天呈：skywalking 不兼容最新的 opentracing 版本。同时，opentracing 也停止了维护，尬住了！后续换 opentelemetry 即可！
//    @Bean
