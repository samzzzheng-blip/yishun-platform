package com.techtron.onebook.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.techtron.onebook.framework.common.util.json.JsonUtils;
import com.techtron.onebook.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${onebook.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class OnebookMybatisAutoConfiguration {
