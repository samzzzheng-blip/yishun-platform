package com.techtron.onebook.framework.jackson.config;

import com.techtron.onebook.framework.common.util.json.JsonUtils;
import com.techtron.onebook.framework.common.util.json.databind.NumberSerializer;
import com.techtron.onebook.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.techtron.onebook.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class OnebookJacksonAutoConfiguration {
