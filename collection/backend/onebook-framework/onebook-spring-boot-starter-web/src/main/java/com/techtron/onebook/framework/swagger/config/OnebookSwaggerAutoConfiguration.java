package com.techtron.onebook.framework.swagger.config;
...
import static com.techtron.onebook.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class OnebookSwaggerAutoConfiguration {
