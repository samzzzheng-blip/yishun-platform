...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.techtron";
    private static final String ARTIFACT_ID = "onebook";
    private static final String PACKAGE_NAME = "com.techtron.onebook";
    private static final String TITLE = "onebook";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.techtron";
        String artifactIdNew = "onebook";
        String packageNameNew = "com.techtron.onebook";
        String titleNew = "onebook";
