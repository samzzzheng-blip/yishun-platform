package com.techtron.onebook.module.system.framework.justauth.config;
...
/**
 * JustAuth 配置类 TODO 天呈：等 justauth 1.4.1 版本发布！！！
 *
 * @author 芋道源码
 */
@Configuration(proxyBeanMethods = false)
@EnableConfigurationProperties({JustAuthProperties.class})
public class OnebookJustAuthConfiguration {
