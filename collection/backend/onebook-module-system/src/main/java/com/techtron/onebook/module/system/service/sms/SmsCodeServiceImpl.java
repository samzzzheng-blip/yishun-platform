...
import com.techtron.onebook.module.system.dal.dataobject.sms.SmsCodeDO;
import com.techtron.onebook.module.system.dal.mysql.sms.SmsCodeMapper;
import com.techtron.onebook.module.system.enums.sms.SmsSceneEnum;
import com.techtron.onebook.module.system.framework.sms.config.SmsCodeProperties;
...
import static com.techtron.onebook.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO 天呈：提升，每个 IP 每天可发送数量
            // TODO 天呈：提升，每个 IP 每小时可发送数量
        }
