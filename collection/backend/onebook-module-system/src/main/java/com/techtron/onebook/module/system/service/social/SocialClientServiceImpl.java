package com.techtron.onebook.module.system.service.social;
...
import com.techtron.onebook.framework.common.util.cache.CacheUtils;
import com.techtron.onebook.framework.common.util.http.HttpUtils;
import com.techtron.onebook.framework.common.util.object.BeanUtils;
import com.techtron.onebook.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.techtron.onebook.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.techtron.onebook.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.techtron.onebook.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.techtron.onebook.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.techtron.onebook.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.techtron.onebook.module.system.dal.dataobject.social.SocialClientDO;
import com.techtron.onebook.module.system.dal.mysql.social.SocialClientMapper;
import com.techtron.onebook.module.system.dal.redis.RedisKeyConstants;
import com.techtron.onebook.module.system.enums.social.SocialTypeEnum;
import com.techtron.onebook.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.techtron.onebook.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.techtron.onebook.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.techtron.onebook.framework.common.util.json.JsonUtils.toJsonString;
import static com.techtron.onebook.module.system.enums.ErrorCodeConstants.*;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${onebook.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${onebook.wxa-subscribe-message.miniprogram-state:formal}")
