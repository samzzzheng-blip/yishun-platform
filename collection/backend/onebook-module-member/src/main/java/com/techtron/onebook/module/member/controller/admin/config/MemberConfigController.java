package com.techtron.onebook.module.member.controller.admin.config;

import com.techtron.onebook.framework.common.pojo.CommonResult;
import com.techtron.onebook.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.techtron.onebook.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.techtron.onebook.module.member.convert.config.MemberConfigConvert;
import com.techtron.onebook.module.member.dal.dataobject.config.MemberConfigDO;
import com.techtron.onebook.module.member.service.config.MemberConfigService;
