package com.techtron.onebook.module.member.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode USER_EXISTS = new ErrorCode(1_004_001_004, "用户账号已经存在");
    ErrorCode OLD_PASSWORD_ERROR = new ErrorCode(1_004_001_005, "旧密码错误");
