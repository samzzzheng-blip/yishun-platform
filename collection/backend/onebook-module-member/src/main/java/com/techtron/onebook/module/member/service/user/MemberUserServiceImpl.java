package com.techtron.onebook.module.member.service.user;
...
import com.techtron.onebook.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import com.techtron.onebook.module.member.controller.app.user.vo.*;
...
import com.techtron.onebook.module.member.mq.producer.user.MemberUserProducer;
...
public class MemberUserServiceImpl implements MemberUserService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public MemberUserDO createUserByAdmin(String mobile, String registerIp, Integer terminal, String password) {
        // 用户已经存在
        MemberUserDO user = memberUserMapper.selectByMobile(mobile);
        if (user != null) {
        ...
        // 用户不存在，则进行创建
        return createUser(mobile, null, null, registerIp, terminal,password);
    }
