package com.techtron.onebook.module.member.service.auth;

import cn.hutool.core.lang.Assert;
import com.techtron.onebook.framework.common.enums.CommonStatusEnum;
import com.techtron.onebook.framework.common.enums.TerminalEnum;
...
import com.techtron.onebook.module.member.convert.auth.AuthConvert;
...
import com.techtron.onebook.module.system.api.logger.LoginLogApi;
import com.techtron.onebook.module.system.api.logger.dto.LoginLogCreateReqDTO;
import com.techtron.onebook.framework.common.biz.system.oauth2.OAuth2TokenCommonApi;
import com.techtron.onebook.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
...
import com.techtron.onebook.module.system.api.social.SocialUserApi;
...
import com.techtron.onebook.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
...
import static com.techtron.onebook.module.member.enums.ErrorCodeConstants.*;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public AppAuthLoginRespVO login(AppAuthLoginReqVO reqVO) {
        ...
        // if (user.getOverDays() == -1) {
        //     memberUserMapper.updateById(
        //             new MemberUserDO().setId(user.getId()).setOverDays(0)
        //     );
        // }
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO 天呈：后续 member user 手机非强绑定，这块需要做下调整；
