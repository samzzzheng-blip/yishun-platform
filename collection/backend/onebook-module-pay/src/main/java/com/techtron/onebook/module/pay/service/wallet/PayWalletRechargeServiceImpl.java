...
import com.techtron.onebook.module.pay.dal.dataobject.wallet.PayWalletRechargePackageDO;
import com.techtron.onebook.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import static com.techtron.onebook.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static com.techtron.onebook.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static com.techtron.onebook.module.pay.enums.ErrorCodeConstants.*;
import static com.techtron.onebook.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static com.techtron.onebook.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @天呈：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
