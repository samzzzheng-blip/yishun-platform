...
import com.techtron.onebook.module.pay.controller.admin.wallet.vo.transaction.PayWalletTransactionPageReqVO;
...
import com.techtron.onebook.module.pay.convert.wallet.PayWalletTransactionConvert;
...
import com.techtron.onebook.module.pay.dal.mysql.wallet.PayWalletTransactionMapper;
...
import static com.techtron.onebook.module.pay.controller.app.wallet.vo.transaction.AppPayWalletTransactionPageReqVO.TYPE_EXPENSE;
import static com.techtron.onebook.module.pay.controller.app.wallet.vo.transaction.AppPayWalletTransactionPageReqVO.TYPE_INCOME;
...
public class PayWalletTransactionServiceImpl implements PayWalletTransactionService {
    ...
    @Override
    public AppPayWalletTransactionSummaryRespVO getWalletTransactionSummary(Long userId, Integer userType, LocalDateTime[] createTime, Integer payWalletBizType) {
        PayWalletDO wallet = payWalletService.getOrCreateWallet(userId, userType);
        return new AppPayWalletTransactionSummaryRespVO()
                .setTotalIncome(payWalletTransactionMapper.selectPriceSum(wallet.getId(), TYPE_INCOME, createTime, payWalletBizType));
    }
