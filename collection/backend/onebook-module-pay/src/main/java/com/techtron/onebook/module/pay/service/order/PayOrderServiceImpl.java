package com.techtron.onebook.module.pay.service.order;
...
import com.techtron.onebook.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import com.techtron.onebook.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import com.techtron.onebook.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import com.techtron.onebook.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
import com.techtron.onebook.module.pay.convert.order.PayOrderConvert;
...
import com.techtron.onebook.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.techtron.onebook.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.techtron.onebook.module.pay.dal.mysql.order.PayOrderMapper;
import com.techtron.onebook.module.pay.dal.redis.no.PayNoRedisDAO;
import com.techtron.onebook.module.pay.enums.notify.PayNotifyTypeEnum;
import com.techtron.onebook.module.pay.enums.order.PayOrderStatusEnum;
import com.techtron.onebook.module.pay.framework.pay.config.PayProperties;
import com.techtron.onebook.module.pay.framework.pay.core.client.PayClient;
import com.techtron.onebook.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.techtron.onebook.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import com.techtron.onebook.module.pay.service.app.PayAppService;
...
import static com.techtron.onebook.module.pay.enums.ErrorCodeConstants.*;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/onebook-cloud/issues/I8SM9H 场景
