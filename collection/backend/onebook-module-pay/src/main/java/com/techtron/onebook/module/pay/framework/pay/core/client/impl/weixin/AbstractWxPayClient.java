package com.techtron.onebook.module.pay.framework.pay.core.client.impl.weixin;
...
import com.techtron.onebook.framework.common.util.io.FileUtils;
...
import static com.techtron.onebook.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.techtron.onebook.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws Exception {
        try {
            switch (config.getApiVersion()) {
                ...
                case API_VERSION_V3:
                    // TODO @天呈：【可能是 wxjava 的 bug】参考 https://github.com/binarywang/WxJava/issues/1557
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/onebook-cloud/issues/ICSFL6
