...
public interface PayWalletMapper extends BaseMapperX<PayWalletDO> {
    ...
    /** Consume frozen funds after an auction is settled. */
    default int consumeFreezePrice(Long id, Integer price) {
        LambdaUpdateWrapper<PayWalletDO> wrapper = new LambdaUpdateWrapper<PayWalletDO>()
