package com.techtron.onebook.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.techtron.onebook.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
