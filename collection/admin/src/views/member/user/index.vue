<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="能量石排序" prop="energyStoneOrder" label-width="96px">
        <el-select
          v-model="queryParams.energyStoneOrder"
          class="!w-160px"
          clearable
          placeholder="请选择"
          @change="handleQuery"
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column align="center" label="账号" prop="mobile" width="120px" />
      <el-table-column align="center" label="昵称" prop="nickname" width="150px" />
      <el-table-column
        align="center"
        label="能量石"
        prop="energyStoneAmount"
        sortable="custom"
        :sort-orders="['descending', 'ascending', null]"
        width="110px"
      >
        <template #default="scope">
          {{ scope.row.energyStoneAmount ?? 0 }}
        </template>
      </el-table-column>
...
const queryParams = reactive({
  ...
  levelId: null,
  groupId: null,
  energyStoneOrder: undefined as 'asc' | 'desc' | undefined
})
...
const handleSortChange = ({ prop, order }: { prop: string; order: string | null }) => {
  if (prop !== 'energyStoneAmount') return
  queryParams.energyStoneOrder =
