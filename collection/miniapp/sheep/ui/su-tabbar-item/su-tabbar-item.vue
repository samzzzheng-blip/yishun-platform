...
<template>
  <view
    class="u-tabbar-item"
    :class="{ 'u-tabbar-item--active': isActive }"
    :style="[addStyle(customStyle)]"
    hover-class="u-tabbar-item--pressed"
    :hover-stay-time="80"
  >
    <view v-if="isCenter" class="tabbar-center-item">
      <image
        class="center-image"
        :class="{ 'center-image--inactive': !isActive }"
        :src="centerIcon"
        mode="aspectFill"
      ></image>
      <text
        class="tabbar-center-item__text"
        :style="{
          color: isActive ? '#752dfd' : parentData.inactiveColor,
        }"
      >
        {{ text }}
      </text>
...
<script>
  ...
  export default {
    ...
    computed: {
      centerIcon() {
        return this.isActive ? this.activeCenterImage : this.centerImage
      }
    },
    created() {
      this.init();
...
<style lang="scss" scoped>
  ...
  .u-tabbar-item--pressed {
    opacity: 0.72;
    transform: scale(0.92);
  }

  .u-tabbar-item--active .u-tabbar-item__icon,
  .u-tabbar-item--active .center-image {
    animation: ys-tabbar-select 260ms cubic-bezier(0.16, 1, 0.3, 1) both;
  }

  .u-tabbar-item--active .u-tabbar-item__text,
  .u-tabbar-item--active .tabbar-center-item__text {
    transform: translateY(-1px);
  }

  @keyframes ys-tabbar-select {
    0% {
      opacity: 0.64;
