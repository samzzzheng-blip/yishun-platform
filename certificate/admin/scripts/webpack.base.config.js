...
// 配置理解：https://blog.csdn.net/qq_36934775/article/details/88119704
const webpackConfigBase = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@smartstyles': path.join(__dirname, '../app/smartstyles'),
      '@tableList': path.join(__dirname, '../app/components/tableList/tableList.js'),
      '@http': path.join(__dirname, '../app/service/http.js')
    },
  },
  resolveLoader: {
  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        include: [
          resolve('../app/styles'),
          resolve('../app/smartstyles'),
          resolve('../app/components'),
          resolve('../node_modules/antd'),
          resolve('../node_modules/draft-js'),
          resolve('../node_modules/video-react')
        ],
