...
$backendPatch = 'D:\home\usr_upload\tmp\20260903\1788417774847_423.zip'
$frontendPatch = 'D:\home\usr_upload\tmp\20260903\1788417775067_393.zip'
$jarPath = 'D:\project\yishun-0.0.1-SNAPSHOT.jar'
$frontendRoot = 'D:\dist'
$javaExe = 'C:\Program Files (x86)\Common Files\Oracle\Java\javapath\java.exe'
$workRoot = 'D:\deploy\rate-range-actions-20260903-1443'
$backupRoot = Join-Path $workRoot 'backup'
$backendFiles = Join-Path $workRoot 'backend-patch'

if ((Get-FileHash $backendPatch -Algorithm SHA256).Hash -ne '24EC0C1C7640DAB75A62DEFFAAF0B3B6F7687FAA19C011AF54C8AA04A7A20317') {
    throw 'Backend patch checksum mismatch.'
}
if ((Get-FileHash $frontendPatch -Algorithm SHA256).Hash -ne '342CF20DC4A8CE69E1C61491026D9E6DA634021E9987A5E24FAA3EBCD19490E6') {
...
try {
    ...
    if ($null -eq $response) { throw $lastHealthError }
