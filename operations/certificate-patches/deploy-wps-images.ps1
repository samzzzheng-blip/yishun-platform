...
$backendPatch = 'D:\home\usr_upload\tmp\20260903\1788415853999_622.zip'
$jarPath = 'D:\project\yishun-0.0.1-SNAPSHOT.jar'
$javaExe = 'C:\Program Files (x86)\Common Files\Oracle\Java\javapath\java.exe'
$workRoot = 'D:\deploy\rate-import-wps-images-20260903-1412'
$backupRoot = Join-Path $workRoot 'backup'
$backendFiles = Join-Path $workRoot 'backend-patch'

if ((Get-FileHash $backendPatch -Algorithm SHA256).Hash -ne '1CE844B3E73BE4CF9DE10D0F089551825874FDCBB0FD38B351FE1823421AF1C7') {
