...
$backendPatch = 'D:\home\usr_upload\tmp\20260902\1788328513483_574.zip'
$frontendPatch = 'D:\home\usr_upload\tmp\20260902\1788328513719_555.zip'
$jarPath = 'D:\project\yishun-0.0.1-SNAPSHOT.jar'
$frontendRoot = 'D:\dist'
$javaExe = 'C:\Program Files (x86)\Common Files\Oracle\Java\javapath\java.exe'
$workRoot = 'D:\deploy\standard-xml-20260902-1355'
$backupRoot = Join-Path $workRoot 'backup'
$backendFiles = Join-Path $workRoot 'backend-patch'

if ((Get-FileHash $backendPatch -Algorithm SHA256).Hash -ne 'D317DCDEB9AA4B79F6EC8C0086CD5A718356672A6406831EC48FFAF476082A42') {
    throw 'Backend patch checksum mismatch.'
}
if ((Get-FileHash $frontendPatch -Algorithm SHA256).Hash -ne '19D88528F032AAD8B2D420F0D3206C986967B68B89C83C96A3394B809210D547') {
